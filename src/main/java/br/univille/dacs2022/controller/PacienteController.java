...
public class PacienteController {
    ...
    public ModelAndView incluirPlano(@ModelAttribute("paciente") 
                                PacienteDTO paciente,
                                BindingResult bindingResult){
        var idPlanoSelect = paciente.getPlanoId();
        var planoSelect = planoService.getById(idPlanoSelect);
        boolean has = paciente.getListaPlanos().stream().anyMatch(plano -> plano.getId() == planoSelect.getId());
    ...
    public ModelAndView removerPlano(@ModelAttribute("paciente") 
                                PacienteDTO paciente,
